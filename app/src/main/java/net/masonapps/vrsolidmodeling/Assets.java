...
public class Assets {
    ...
    public static final String FOLDER_SHAPES = "primitives/";
    ...
    public static final String SHAPE_CUBE = FOLDER_SHAPES + "cube.ply";
    public static final String SHAPE_SPHERE = FOLDER_SHAPES + "sphere.ply";
    public static final String SHAPE_CYLINDER = FOLDER_SHAPES + "cylinder.ply";
    public static final String SHAPE_CONE = FOLDER_SHAPES + "cone.ply";
    public static final String SHAPE_TORUS = FOLDER_SHAPES + "torus.ply";
}
